...
public class RAASD extends SequentialCommandGroup {
  /** Creates a new ExampleAuto. */
  public RAASD(DriveSubsystem driveSubsystem, Intake fuelSubsystem, Shooter shooter, Conveyor convey,
    ...
    addCommands(
        ...
        new AutoDrive(driveSubsystem, -0.5, 0.0).withTimeout(.35),
        new AutoDrive(driveSubsystem, 0, -.65).withTimeout(.22),
