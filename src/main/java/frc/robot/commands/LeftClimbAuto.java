...
public class LeftClimbAuto extends SequentialCommandGroup {
  /** Creates a new ExampleAuto. */
  public LeftClimbAuto(DriveSubsystem driveSubsystem,FuelSubsystem fuelSubsystem,Shooter shooter,Conveyor convey) {
