...
public class CenterClimbAuto extends SequentialCommandGroup {
  /** Creates a new CenterAuto. */
  public CenterClimbAuto(DriveSubsystem driveSubsystem,FuelSubsystem fuelSubsystem,Shooter shooter,Conveyor convey) {
